...
"compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/MP6DX 15 - Bowser Orb Byte Checker.asm" && python "compiler/gecko.py" a.out 801BE538` tmp/15.txt1
"compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/MP6DX 16 - Bowser Orb Rewrite.asm" && python "compiler/gecko.py" a.out 801BE730 tmp/16.txt1
"compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/MP6DX 17 - Star Blocking.asm" && python "compiler/gecko.py" a.out 80500180 tmp/17.txt1

copy "src\asm\MP6DX 18 - Debug Orb Enablers.txt" tmp\18.txt1
copy "src\asm\MP6DX 19 - Orb Tables.txt" tmp\19.txt1
