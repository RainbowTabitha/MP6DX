...
wine "compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/MP6DX 14 - DK Orb Shell.asm" && python "compiler/gecko.py" a.out 80249B8C tmp/13.txt1 -ow
wine "compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/MP6DX 15 - Pink Boo Orb Shell.asm" && python "compiler/gecko.py" a.out 80249BDC tmp/13.txt1 -ow
