...
wine "compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/MP6DX 14 - Koopa Orb Rewrite.asm" && python "compiler/gecko.py" a.out 801BE730 tmp/14.txt1
