...
wine "compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/DK and Pink Boo Orb/Pink Boo Day 1.asm" && python "compiler/gecko.py" a.out 801B1BB4 tmp/pink_boo_orb_day_1.txt1
wine "compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/DK and Pink Boo Orb/Pink Boo Day 2.asm" && python "compiler/gecko.py" a.out 801B1EF8 tmp/pink_boo_orb_day_2.txt1
...
wine "compiler/codewrite/powerpc-gekko-as.exe" -a32 -mbig -mregnames -mgekko "src/asm/DK and Pink Boo Orb/Pink Boo Orb Pos Fixer.asm" && python "compiler/gecko.py" a.out 801B1C60 tmp/pink_boo_orb_pos_fixer.txt1
